...
{
    public partial class SolverModel
    {
        /// <summary>
        /// model input class for CaptchaSolverModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for CaptchaSolverModel.
        /// </summary>
        ...
        private static PredictionEngine<ModelInput, ModelOutput> CreatePredictEngine()
        {
            ...
            if (assembly == null)
                throw new FileNotFoundException("Could not find the assembly.");

            using (var stream = assembly.GetManifestResourceStream(typeof(SolverModel).FullName + ".mlnet"))
            {
                if (stream == null)
